var brazilian = {
  ...
  mainMenu: {
    ...
    howtoplay: {
      ...
      2: `Mantenha-se informado sobre seus itens com seu inventário no canto superior direito.`,
      3: `O jogo possui vários finais, se você conseguiu um ruim, talvez tenha esquecido de olhar em algum lugar.`,
    ...
    credits: {
      ...
      1: `O <a href="https://patorjk.com/software/taag/" target="_blank">gerador de texto em ASCII do Patorjk's</a> foi usado para gerar os títulos em ASCII, meus agradecimentos ao dev por salvar um pouco do meu tempo!`,
...
chooseLocation: {
  0: `Hora do Tutorial!<br><br>`,
  1: ` No menu do canto inferior direito, há um botão clicável que abre um mapa que indica sua localização atual em amarelo,`,
  2: ` clique nas diferentes localizações da ilha para ir até elas, lembre-se de que algumas áreas podem estar bloqueadas!`,
},
...
enterForestWOStick: {
  ...
  5: `... Na verdade, esse graveto é bem inútil, é melhor só deixar ele aí.<br><br>`,
  6: window.brazilianGlobals.WWYD,
...
islandFirst: {
  ...
  5: ` você, com suas mãos vazias, começa a cavar o X com as mãos, já que esse lugar não deve ter uma pá.<br><br>`,
...
farmSeeCropsWSticker: {
  ...
  4: `- Garoto ocê pode dá uma bela vizoiada nelas, meu cenoumano! <br><br>`,
...
wallAlreadyUsedPass: {
  ...
  2: `Você tenta falar algo, mas a criatura tampa os ouvidos e fica repetindo "blablabla", que crinaçinha!`,
},

cave: {
  0: `Há uma grande caverna à sua frente,`,
  1: ` você consegue ouvir pequenos grunhidos vindo dela...<br><br>`,
...
castle: {
  ...
  3: `<a href="#" onclick="updateScreen('bifurcation','castleEnter')">Entrar</a>`,
},
...
castleEnter: {
  ...
  4: `Para a direita, temos o mercadinho que aparenta ter umas coisas interessantes.<br><br>`,
  5: `Para onde você quer ir?<br><br>`,
  6: `<a href="#" onclick="updateScreen('king','palace')">Para o palácio do rei</a><br>`,
  7: `<a href="#" onclick="updateScreen('shop','shop')">Para o mercadinho</a>`,
},
...
palaceFirst: {
  ...
  3: window.brazilianGlobals.WWYS,
  4: `<a href="#" onclick="updateScreen('king','kingWhoAreYou')">Quem é você?</a><br>`,
...
kingHowDoThis: {
  ...
  1: ` vá para o altar a sudeste daqui, você encontrará um anjo que te guiará melhor que eu,`,
...
shop: {
  ...
  4: `<a href="#" onclick="updateScreen('king','palace')">Ir para o palácio</a>`,
},
...
altarFirst: {
  ...
  1: ` Percebi que o rei me convocou para te ajudar na missão de derrotar <i>Leshy</i>, o espírito maligno.<br><br>`,
  2: `- Como o rei havia dito, armas comuns não vão funcionar em <i>seu</i> corpo,`,
  ...
  13: `<a href="#" onclick="updateScreen('angel','angelHowSwordDisappear')">Como que a lâmina sumiu?</a><br>`,
  14: `<a href="#" onclick="updateScreen('angel','angelSearchSwordYourself')">Por que você não procurou a espada por si mesma?</a><br>`,
  15: `<a href="#" onclick="updateScreen('angel','angelBye')">Tchau!</a>`,
},
...
cabin: {
  ...
  2: window.brazilianGlobals.WWYD,
...
cabinEnter: {
  ...
  8: `<a href="#" onclick="updateScreen('leshy','leshyFate')">Escutá-la</a>`,
},

leshyLostSoul: {
  0: `<i>- O que temos aqui...`,
  1: `<b><i> Uma alma perdida</b><br><br>`,
  2: `A entidade retira um pêndulo feito de gravetos do breu da cabana e começa a balançá-lo lentamente.`,
...
leshyWGoggles: {
  ...
  15: `<a href="#" onclick="updateScreen('leshySkull','leshySkull')">Se recompor</a>`,
},
...
leshyWODarkTunic: {
  ...
  1: ` o chão grudento começa a inflamar rapidamente,`,
  2: ` subindo as chamas ao seu corpo.<br><br>`,
  3: `O calor é demais,`,
...
leshyTransform: {
  ...
  4: ` A barulheira cessa antes que você tivesse tempo de pensar em algo que fizesse sentido.<br><br>`,
  5: `.`,
  6: ` .`,
  7: ` .<br><br>`,
...
leshyAftermath: {
  0: `Num piscar de olhos, o monstro fica totalmente podre,`,
...
leshyAngel: {
  ...
  6: `- Isso significa que a ilha agora está livre da maldição de <i>Leshy</i>,`,
...
ending: {
  ...
  8: ` você vê a sua casa do outro lado dela,`,
